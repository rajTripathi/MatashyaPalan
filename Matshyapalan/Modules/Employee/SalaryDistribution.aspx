<%@ Page Title="" Language="C#" MasterPageFile="~/MainbyA.Master" AutoEventWireup="true" CodeBehind="SalaryDistribution.aspx.cs" Inherits="Matshyapalan.Modules.Employee.SalaryDistribution" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="wrapper row">
        <div class="col-md-10 frm pull-right animated slideInRight">
            ...
            <form class="form-horizontal" runat="server" id="Form1" role="form">
                <div class="row">
                    <div class="col-md-12">
                        <legend>Salary Distribution</legend>
                        <hr />
                    </div>
                </div>
    ...
    optionsCaption: "------छान्नुहोस्-------", event: { change: PartyChange }'>
                 ...
                 <button id="btnAdd" class="btn btn-primary" data-bind="click: Add">Search</button>

                <div class="row">
                    <div class="col-md-3">
                        Salary Amount<span class="mandatory">*</span>
                    </div>
                    <div class="col-md-5">
                        <input type="text" class="form-control" id="txtRate" data-bind="value: FishRate" />
                    </div>
                   ...
                   <div class="row">
                    <div class="col-md-3">
                        Paid Amount<span class="mandatory">*</span>
                    </div>
                    <div class="col-md-5">
                        <input type="text" class="form-control" id="txtRate" data-bind="value: FishRate" />
                    </div>
                   ...
                   <div class="row">
                    <div class="col-md-3">
                        Due Amount<span class="mandatory">*</span>
                    </div>
                    <div class="col-md-5">
                        <input type="text" class="form-control" id="txtRate" data-bind="value: FishRate" />
                    </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        Advance Amount<span class="mandatory">*</span>
                    </div>
                    <div class="col-md-5">
                        <input type="text" class="form-control" id="txtRate" data-bind="value: FishRate" />
                    </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        Received by<span class="mandatory">*</span>
                    </div>
                    <div class="col-md-5">
