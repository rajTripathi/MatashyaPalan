<%@ Page Title="" Language="C#" MasterPageFile="~/MainbyA.Master" AutoEventWireup="true" CodeBehind="HarvestSetup.aspx.cs" Inherits="Matshyapalan.Modules.Fishery.HarvestSetup" %>
...
<div class="col-md-10 frm pull-right animated slideInRight">
            ...
            <div class="row">
                <div class="col-md-12">
                  <legend>Harvest Setup</legend><hr />
                  </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                       <input type="text" class="form-control" id="txtHarvest" data-bind="value: Harvest" />
                  </div>
            </div>
            <br />
            <br />
