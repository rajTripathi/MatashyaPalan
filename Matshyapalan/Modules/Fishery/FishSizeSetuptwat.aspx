<%@ Page Title="" Language="C#" MasterPageFile="~/MainbyA.Master" AutoEventWireup="true" CodeBehind="FishSizeSetup.aspx.cs" Inherits="Matshyapalan.Modules.Fishery.FishSizeSetup" %>
...
<div class="col-md-10 frm pull-right animated slideInRight">
            ...
            <div class="row">
                <div class="col-md-12">
                  <legend>Fish Size Setup</legend><hr />
                  </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                       <input type="text" class="form-control" id="txtfishSize" data-bind="value: fishSize" />
                  </div>
            </div>
            <br />
            <br />
