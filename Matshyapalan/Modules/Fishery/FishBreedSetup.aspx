<%@ Page Title="" Language="C#" MasterPageFile="~/MainbyA.Master" AutoEventWireup="true" CodeBehind="FishBreedSetup.aspx.cs" Inherits="Matshyapalan.Modules.Fishery.FishBreedSetup" %>
...
<div class="col-md-10 frm pull-right animated slideInRight">
            ...
            <div class="row">
                <div class="col-md-12">
                  <legend>Fish Breed Setup</legend><hr />
                  </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                       <input type="text" class="form-control" id="txtBreed" data-bind="value: Breed" />
                  </div>
            </div>
            <br />
            <br />
