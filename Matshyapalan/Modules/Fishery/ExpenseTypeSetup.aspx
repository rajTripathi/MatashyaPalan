<%@ Page Title="" Language="C#" MasterPageFile="~/MainbyA.Master" AutoEventWireup="true" CodeBehind="ExpenseTypeSetup.aspx.cs" Inherits="Matshyapalan.Modules.Fishery.ExpenseTypeSetup" %>
...
<div class="col-md-10 frm pull-right animated slideInRight">
            ...
            <div class="row">
                <div class="col-md-12">
                  <legend>Expense Type Setup</legend><hr />
                  </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                       <input type="text" class="form-control" id="txtExpenseType" data-bind="value: ExpenseType" />
                  </div>
            </div>
            <br />
            <br />
